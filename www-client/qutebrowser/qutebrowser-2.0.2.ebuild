...
DESCRIPTION="A keyboard-driven, vim-like browser based on QtWebEngine"
...
IUSE="scripts test +pygments adblock"
...
RDEPEND="
	...
	pygments? ( >=dev-python/pygments-2.7.2[${PYTHON_USEDEP}] )
