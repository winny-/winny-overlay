...
IUSE="alsa cg cpu_flags_x86_sse dbus egl ffmpeg flac freetype gles gles3
	jack kms libcaca libusb materialui miniupnpc openal +opengl +ozone
	pulseaudio qt rgui sdl +sdl2 sixel subtitles ssl stripes systemd
	tinyalsa udev vulkan X xrandr xmb xv wayland +zlib"
